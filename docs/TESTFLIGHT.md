...
| 1.0.3 (28) | 2026-05-20 | Sentry signal-to-noise: tag http.url/method/code em axios errors, demote transient timeouts para warning. Supply-chain hardening: axios ^1.13.6 -> ^1.15.1 (npm resolve 1.16.1, fora do CVE-2025-62718 e da janela de compromise mar/26). Pin exato tanstack react-query 5.100.7. npm audit fix mobile (high 4 -> 0) + backend (critical 1 -> 0, high 4 -> 1 com drizzle deferido). |
